...
public class Navecita : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        navecita.MovePosition(new Vector2(navecita.position.x + movimiento, navecita.position.y)); //mover de izquiera a derecha

        if (Input.GetAxis("Jump") == 1.0 && balaE==null) //para disparar con jump y generar otra bala
        {
